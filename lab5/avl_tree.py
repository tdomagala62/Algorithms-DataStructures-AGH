...
class Tree:
    ...
    def __height(self, node, max_height=0):
...
class AVLNode(Node):
    def __init__(self, height, *args):
        super(AVLNode, self).__init__(*args)
        self.height = height
...
class AVLTree(Tree):
    ...
    def rotation_left_left(self):
        pass

    def rotation_right_right(self):
        pass

    def rotation_right_left(self):
        pass

    def rotation_left_right(self):
        pass

    def insert(self, key, value, node=None):
        if node is None:
            if self.root is None:
                self.root = AVLNode(0, key, value)
                return
            else:
                node = self.root
        if node:
